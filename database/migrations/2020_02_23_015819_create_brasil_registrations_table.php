...
class CreateBrasilRegistrationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('brasil_registrations', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('brasil_registrations');
    }
}
