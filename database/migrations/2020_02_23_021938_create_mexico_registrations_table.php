...
class CreateMexicoRegistrationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mexico_registrations', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('mexico_registrations');
    }
}
