...
class CreateColombiaRegistrationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('colombia_registrations', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('colombia_registrations');
    }
}
