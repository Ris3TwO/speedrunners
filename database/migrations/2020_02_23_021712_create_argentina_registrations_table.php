...
class CreateArgentinaRegistrationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('argentina_registrations', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('argentina_registrations');
    }
}
