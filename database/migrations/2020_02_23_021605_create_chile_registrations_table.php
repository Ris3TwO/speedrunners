...
class CreateChileRegistrationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('chile_registrations', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('chile_registrations');
    }
}
