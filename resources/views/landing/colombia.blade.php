                                ...
                                <div class="col-lg-9 inputs">
                                    <div class="form-row form-row-space justify-content-around">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" ng-model="names" required class="form-control"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" required ng-model="lastnames" class="form-control"
                                                name="inputLastnames" id="inputLastnames"
                                        ...
                                        <div class="form-group form-radio col-md-6">
                                            ...
                                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                <label class="btn btn-light active"
                                                    ng-click="selectGender('MASCULINO')">
                                    ...
                                    <div class="form-row justify-content-around break">
                                        <div class="form-group form-radio col-md-6">
                                            ...
                                            <input type="text" required name="inputAge" ng-model="age"
                                    ...
                                    <div class="form-row justify-content-around break">
                                        <div class="form-group form-radio col-md-6">
                                            ...
                                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                <label class="btn btn-light active"
                                                    ng-click="selectTeam('ADIDAS RUNNERS')">
                            ...
                            <div class="col-lg-12">
                                <div class="row justify-content-center text-left">
                                    ...
                                    <div class="col-lg-8 d-flex align-items-center">
                                        <div>
                                            <h1 class="success-title">Hola <p
                                                    ng-bind="adidasForm.inputNames.$viewValue"></p>
                                            </h1>
